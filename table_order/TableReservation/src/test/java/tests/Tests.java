...
public class Tests {
	...
	public void testAddOrderPositive() {
		...
		Order order = new Order(1,"Lior","05421811610",too,4);
	...
	public void testOrderATableInAResturantCaseTableIsFree(){
		...
		Order order = new Order(101,"Hana Rozen" , "0542134567", timeOfOrder , 4);
	...
	public void testOrderATableInAResturantCaseTableIsNotFree(){
		...
		LocalDate date = LocalDate.of(2018, 7, 15);
		TimeOfOrder timeOfOrder = new TimeOfOrder(TIMEOFDAY.TWELF ,date);
		Order order1 = new Order(101,"Hana Rozen" , "0542134567", timeOfOrder , 4);
		Order order2 = new Order(102,"Yorm Gaon" , "0542134547", timeOfOrder , 4);
	...
	public void testOrderATableInAResturantCaseSameTableDifferentHours(){
		...
		Order order1 = new Order(101,"Hana Rozen" , "0542134567", timeOfOrder1 , 4);
		Order order2 = new Order(102,"Yorm Gaon" , "0542134547", timeOfOrder2 , 4);
